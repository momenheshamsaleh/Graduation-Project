...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    return <div className={cn("bg-background border p-2 text-sm", className)} ref={ref} {...props} />
  },
)
...
const ChartTooltip = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    return (
      <div
        className={cn("pointer-events-none absolute z-50 opacity-0 transition-opacity duration-150", className)}
        ref={ref}
        {...props}
      />
    )
